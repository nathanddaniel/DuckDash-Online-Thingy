...
# Load the TF Lite model optimized for Edge TPU
TFLITE_FILENAME = 'efficientdet-lite-road-signs_edgetpu.tflite'  # Updated filename
...
image.save("road-sign-detect-result.jpg")  # Ensure the image is saved properly
